...
def main():
    """
    Run the Research Contract Adviser Agent review pipeline from the command line.
    ...
    if len(sys.argv) < 2:
        ...
        console.print("python src/run_review.py data/sample_contracts/sample_contract.txt")
        console.print("python src/run_review.py data/sample_contracts/risky_contract.txt")
        return
